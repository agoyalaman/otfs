function [rx_del_Dop,chirp,invchirp,xchirp,impulse_dD] = gen_otfs(delay_vec,delay_pos,dop_vec,dop_val,mode,snr_db,N,samp_const)
...
%     subplot(1,2,2);
%     imagesc(angle(X_nm));
    [Y_nm,snr_otfs,s_n,r] = ofdm(X_nm,sigma,Ns,L,fs,h_gains,h_doppler,strOpt,1,0.00/fs,samp_const);
